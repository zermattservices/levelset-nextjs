...
import Label from "../../Label"; // plasmic-import: dxHdB4vixcsg/component
import TextInput from "../../TextInput"; // plasmic-import: 4ipfDfKfLPWW/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: cw0lk3p4rY3N/component
import Description from "../../Description"; // plasmic-import: Q6qI-3t1ZNIx/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: tGaYhUDpN6hE/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__pXsAj, {
          [sty.freeBoxiconEnd__pXsAJzNNn]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__pXsAJxU5Pt]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__pXsAJyhkO]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__knHdD, {
            [sty.freeBoxiconStart__knHdDxU5Pt]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__knHdDyhkO]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___7XCw6)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__gLak3, {
            [sty.freeBoxiconEnd__gLak3ZNNn]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__gLak3XU5Pt]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__siUrx)}
                role={"img"}
              />
            ),
