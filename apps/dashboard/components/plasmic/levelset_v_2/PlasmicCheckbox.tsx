...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: RwRYUj3l9CMU/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: 3DMA9TVkAaIj/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: fpckcqPP3aXL/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__xf14)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__d0Opk)}
            role={"img"}
          />
        ) : null}
      </div>
