...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: EnN3aP0_NXc5/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__eBogq)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__t7MGo)}>
            <div
              className={classNames(
                projectcss.all,
