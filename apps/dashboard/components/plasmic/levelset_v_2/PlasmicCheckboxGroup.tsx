...
import Checkbox from "../../Checkbox"; // plasmic-import: RwRYUj3l9CMU/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: vvAH9ZumpLZE/css
...
function PlasmicCheckboxGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__jfa8W)}>
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__uiEbd)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__g1J3X)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__vjCpu)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
