/**
 * POST /api/onboarding/documents/upload-url
 *
 * Get a signed upload URL for a document during onboarding.
 * Same as /api/documents/upload-url but without Levelset Admin role check.
 */
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  if (error) {
    console.error('[onboarding/documents/upload-url] Failed to create signed URL', error);
