...
const en = {
  ...
  home: {
    ...
    noActivitiesDesc: "Your ratings, infractions, and reviews will appear here",
  },
  recentActivities: {
    rating: "Rating",
    ...
    discAction: "Action",
    review: "Review",
    ratedBy: "Rated by {{name}}",
    points: "{{count}} pts",
    avgRating: "{{value}} avg",
    criteriaBreakdown: "Criteria Breakdown",
    last4Average: "Last 4 Rating Average",
    notes: "Notes",
    acknowledged: "Acknowledged",
    notAcknowledged: "Not Acknowledged",
    signed: "Signed",
    notSigned: "Not Signed",
    currentPointTotal: "Current Point Total",
    teamMemberSignature: "Team Member Signature",
    leaderSignature: "Leader Signature",
    leader: "Leader",
    comingSoon: "Full review details coming soon",
  },
  employeeOverview: {
    overview: "Overview",
    positionalExcellence: "Positional Excellence",
  ...
  submissions: {
    ...
    noSubmissionsDesc: "Form submissions will appear here",
    submittedBy: "Submitted by {{name}}",
    filterTitle: "Filter Submissions",
    formType: "Form Type",
    formTypeAll: "All",
    formTypeRatings: "Ratings",
    formTypeInfractions: "Infractions",
    formTypeActions: "Actions",
    dateRange: "Date Range",
    employee: "Employee",
    submitter: "Submitter",
    apply: "Apply",
  ...
  setup: {
    title: "Today's Setup",
    employees: "Employees",
    noBlocks: "No blocks configured for this day",
    noEmployees: "No employees scheduled",
    noResults: "No matching employees",
    assigned: "Assigned",
    unassigned: "Unassigned",
    dragHere: "Drag employee here",
    foh: "FOH",
    boh: "BOH",
    required: "Required",
    optional: "Optional",
...
const es = {
  ...
  home: {
    ...
    noActivitiesDesc: "Tus calificaciones, infracciones y reseñas aparecerán aquí",
  },
  recentActivities: {
    rating: "Calificación",
    ...
    discAction: "Acción",
    review: "Reseña",
    ratedBy: "Calificado por {{name}}",
    points: "{{count}} pts",
    avgRating: "{{value}} prom",
    criteriaBreakdown: "Desglose de Criterios",
    last4Average: "Promedio Últimas 4 Calificaciones",
    notes: "Notas",
    acknowledged: "Reconocida",
    notAcknowledged: "No Reconocida",
    signed: "Firmado",
    notSigned: "No Firmado",
    currentPointTotal: "Total de Puntos Actual",
    teamMemberSignature: "Firma del Miembro del Equipo",
    leaderSignature: "Firma del Líder",
    leader: "Líder",
    comingSoon: "Detalles completos de reseña próximamente",
  },
  employeeOverview: {
    overview: "Resumen",
    positionalExcellence: "Excelencia Posicional",
    ...
    totalPoints: "Puntos",
    infractionCount: "Infracciones",
    actionCount: "Acciones",
    allPositions: "Todas las Posiciones",
    allRaters: "Todos los Evaluadores",
    position: "Posición",
    rater: "Evaluador",
    zone: "Zona",
    ...
    copied: "¡Copiado!",
    noPositionData: "Sin datos de posición aún",
    noRatings: "No se encontraron calificaciones",
    noDisciplineRecords: "Sin registros de disciplina",
    positions: "Posiciones",
    allRatings: "Todas las Calificaciones",
    ratings: "calificaciones (últimos 90d)",
    type: "Tipo",
    infraction: "Infracción",
    action: "Acción",
    start: "Inicio",
  ...
  actionMenu: {
    ...
    recordInfraction: "Registrar Infracción",
  ...
  submissions: {
    ...
    noSubmissionsDesc: "Los envíos de formularios aparecerán aquí",
    submittedBy: "Enviado por {{name}}",
    filterTitle: "Filtrar Envíos",
    formType: "Tipo de Formulario",
    formTypeAll: "Todos",
    formTypeRatings: "Calificaciones",
    formTypeInfractions: "Infracciones",
    formTypeActions: "Acciones",
    dateRange: "Rango de Fechas",
    employee: "Empleado",
  ...
  comingSoon: {
    title: "Próximamente",
    subtitle: "Esta función se está desarrollando para ti",
  },
  levi: {
    title: "Levi",
    chat: "Chat",
  ...
  setup: {
    title: "Configuración de Hoy",
    employees: "Empleados",
    noBlocks: "No hay bloques configurados para este día",
    noEmployees: "No hay empleados programados",
    noResults: "No se encontraron empleados",
    assigned: "Asignados",
    unassigned: "Sin asignar",
    dragHere: "Arrastra un empleado aquí",
    foh: "FOH",
    boh: "BOH",
    required: "Requerido",
    optional: "Opcional",
