...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/solutions/development`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${baseUrl}/solutions/operations`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${baseUrl}/solutions/intelligence`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.8 },
    ...featurePages,
    ...integrationPages,
