...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: FmTyG3ZcHL3b/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox___1JYlx)}>
        <div className={classNames(projectcss.all, sty.freeBox__swLe7)} />
      </div>
      {renderPlasmicSlot({
