...
import Radio from "../../Radio"; // plasmic-import: FmTyG3ZcHL3b/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: 6HNvsRva5DGa/css
...
function PlasmicRadioGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__fuRt6)}>
            <Radio
              className={classNames("__wab_instance", sty.radio__syuEe)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__ktQy)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__fkkm2)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
