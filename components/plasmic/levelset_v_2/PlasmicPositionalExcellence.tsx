...
import { PositionalRatings } from "../../CodeComponents/PositionalRatings"; // plasmic-import: LAVhHSecbW0h/codeComponent
...
import sty from "./PlasmicPositionalExcellence.module.css"; // plasmic-import: BUkAZC9D-uE7/css
...
export type PlasmicPositionalExcellence__VariantMembers = {};
export type PlasmicPositionalExcellence__VariantsArgs = {};
type VariantPropType = keyof PlasmicPositionalExcellence__VariantsArgs;
export const PlasmicPositionalExcellence__VariantProps =
  new Array<VariantPropType>();

export type PlasmicPositionalExcellence__ArgsType = {};
type ArgPropType = keyof PlasmicPositionalExcellence__ArgsType;
export const PlasmicPositionalExcellence__ArgProps = new Array<ArgPropType>();

export type PlasmicPositionalExcellence__OverridesType = {
  root?: Flex__<"div">;
  ...
  positionalRatings?: Flex__<typeof PositionalRatings>;
};

export interface DefaultPositionalExcellenceProps {}
...
function PlasmicPositionalExcellence__RenderFunc(props: {
  variants: PlasmicPositionalExcellence__VariantsArgs;
  args: PlasmicPositionalExcellence__ArgsType;
  overrides: PlasmicPositionalExcellence__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">
          {PlasmicPositionalExcellence.pageMetadata.title}
        </title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicPositionalExcellence.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
            ...
            <div className={classNames(projectcss.all, sty.freeBox__q2Oez)}>
              <div className={classNames(projectcss.all, sty.freeBox___82DkP)}>
                <div className={classNames(projectcss.all, sty.freeBox__igRkK)}>
                  <div
                    className={classNames(projectcss.all, sty.freeBox___7MbDt)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox__ebbmL)}
                  >
                    <LevelsetButton
                      ...
                      onClick={async event => {
                        ...
                        $steps["goToPeaClassic"] = true
                          ? (() => {
                              const actionArgs = {
                                destination: `/positional-excellence-classic`
                              };
                              return (({ destination }) => {
                                if (
                                  typeof destination === "string" &&
                          ...
                          : undefined;
                        if (
                          $steps["goToPeaClassic"] != null &&
                          typeof $steps["goToPeaClassic"] === "object" &&
                          typeof $steps["goToPeaClassic"].then === "function"
                        ) {
                          $steps["goToPeaClassic"] =
                            await $steps["goToPeaClassic"];
                        }
                      }}
                      size={"compact"}
                    >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox___9LQfr)}>
              <div className={classNames(projectcss.all, sty.freeBox___7G7OF)}>
                <PositionalRatings
                  data-plasmic-name={"positionalRatings"}
                  data-plasmic-override={overrides.positionalRatings}
                  className={classNames(
                    "__wab_instance",
                    sty.positionalRatings
                  )}
                  density={"comfortable"}
                  locationId={(() => {
                    try {
...
const PlasmicDescendants = {
  ...
  peaRubric: ["peaRubric"],
  verticalStack3: ["verticalStack3", "positionalRatings"],
...
type NodeDefaultElementType = {
  ...
  verticalStack3: "div";
  positionalRatings: typeof PositionalRatings;
};

type ReservedPropsType = "variants" | "args" | "overrides";
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicPositionalExcellence__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicPositionalExcellence__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicPositionalExcellence__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicPositionalExcellence__ArgProps,
          internalVariantPropNames: PlasmicPositionalExcellence__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicPositionalExcellence__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicPositionalExcellence";
  } else {
    func.displayName = `PlasmicPositionalExcellence.${nodeName}`;
  }
  return func;
}

export const PlasmicPositionalExcellence = Object.assign(
  // Top-level PlasmicPositionalExcellence renders the root element
  makeNodeComponent("root"),
  {
    ...
    positionalRatings: makeNodeComponent("positionalRatings"),

    // Metadata about props expected for PlasmicPositionalExcellence
    internalVariantProps: PlasmicPositionalExcellence__VariantProps,
    internalArgProps: PlasmicPositionalExcellence__ArgProps,

    // Page metadata
    pageMetadata: {
      title: "Positional Excellence | Levelset",
      description: "",
      ogImageSrc: "",
      canonical: ""
    }
...
export default PlasmicPositionalExcellence;
/* prettier-ignore-end */
