...
import SliderThumb from "../../SliderThumb"; // plasmic-import: z-ZuWr7NPtg-/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: vYbNTWJRfILJ/css
...
function PlasmicRangeSlider__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__nFmg)}>
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__cwEkP)}>
        <div
