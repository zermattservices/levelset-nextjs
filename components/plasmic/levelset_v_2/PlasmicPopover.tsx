...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: fbEZHtcCcnZX/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: 08mGPWjw6-rt/css
  ...
  return (
    <BaseDialogTrigger
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div
                  className={classNames(projectcss.all, sty.freeBox___3QjW9)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__o71X4)}
            label={"Open Popover"}
          />
        ),
