...
import sty from "./PlasmicDrawerOldV2.module.css"; // plasmic-import: Plh-Ei-tZDG1/css
...
export type PlasmicDrawerOldV2__VariantMembers = {};
export type PlasmicDrawerOldV2__VariantsArgs = {};
type VariantPropType = keyof PlasmicDrawerOldV2__VariantsArgs;
export const PlasmicDrawerOldV2__VariantProps = new Array<VariantPropType>();

export type PlasmicDrawerOldV2__ArgsType = {
  selectedEmployee?: any;
  initialProfileTab?: string;
  discActions?: any;
  employeesDiscQuery?: any;
  discActionsRubric?: any;
  activeAppUser?: any;
  infractionsQuery?: any;
  itemName?: React.ReactNode;
  pointValue3?: React.ReactNode;
  itemName2?: React.ReactNode;
  pointValue5?: React.ReactNode;
};
type ArgPropType = keyof PlasmicDrawerOldV2__ArgsType;
export const PlasmicDrawerOldV2__ArgProps = new Array<ArgPropType>(
  "selectedEmployee",
  "initialProfileTab",
  "discActions",
  "employeesDiscQuery",
...
export type PlasmicDrawerOldV2__OverridesType = {
...
export interface DefaultDrawerOldV2Props {
  selectedEmployee?: any;
  initialProfileTab?: string;
  discActions?: any;
  employeesDiscQuery?: any;
...
function PlasmicDrawerOldV2__RenderFunc(props: {
  variants: PlasmicDrawerOldV2__VariantsArgs;
  args: PlasmicDrawerOldV2__ArgsType;
  overrides: PlasmicDrawerOldV2__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    <DrawerV2
      ...
      closable={true}
      closeButtonClassName={classNames({ [sty["pcls_JKnPB9NXrSnE"]]: true })}
      ...
      drawerBodyClassName={classNames({ [sty["pcls_BcV6IV-AGHba"]]: true })}
      drawerContentWrapperClassName={classNames({
        [sty["pcls_CJdbZMiHuaUk"]]: true
      })}
        ...
        >
          ...
          >
            <div
              ...
              className={classNames(projectcss.all, sty.textAndOnlineIndicator)}
            >
              <div
                  ...
                  {(() => {
                    try {
                      return (() => {
                        {
                          {
                            return $props.selectedEmployee?.full_name;
                          }
                        }
                      })();
                    } catch (e) {
            ...
            >
              <React.Fragment>
                {(() => {
                  try {
                    return $props.selectedEmployee?.role;
                  } catch (e) {
                    if (
                      e instanceof TypeError ||
                      e?.plasmicType === "PlasmicUndefinedDataError"
          ...
          >
            ...
            >
              <TabsContainer
                ...
                initialKey={(() => {
                  try {
                    return $props.initialProfileTab;
                  } catch (e) {
                    if (
                      e instanceof TypeError ||
                      e?.plasmicType === "PlasmicUndefinedDataError"
              ...
              >
                <DataCtxReader__>
                  {$ctx => (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__t0Tqs)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
                                  ...
                                  >
                                    ...
                                    >
                                      {(_par =>
                                        ...
                                        (() => {
                                          try {
                                            return $props.infractionsQuery.data;
                                          } catch (e) {
                                            if (
                                              e instanceof TypeError ||
                                              e?.plasmicType ===
                                                  ...
                                                  <AntdSelect
                                                    ...
                                                    options={(() => {
                                                      ...
                                                      __composite["0"][
                                                        ...
                                                        $props.discActionsRubric.data[0].action;
                                                      __composite["0"][
                                                        "value"
                                                      ] =
                                                        $props.discActionsRubric.data[0].id;
                                                      __composite["1"]["type"] =
                                                        "option";
                                                      __composite["1"][
                                                        "label"
                                                      ] =
                                                        $props.discActionsRubric.data[1].action;
                                                      __composite["1"][
                                                        "value"
                                                      ] =
                                                        $props.discActionsRubric.data[1].id;
                                                      __composite["2"][
                                                        "label"
                                                      ] =
                                                        $props.discActionsRubric.data[2].action;
                                                      __composite["2"][
                                                        "value"
                                                      ] =
                                                        $props.discActionsRubric.data[2].id;
                                                      __composite["3"][
                                                        "label"
                                                      ] =
                                                        $props.discActionsRubric.data[3].action;
                                                      __composite["3"][
                                                        "value"
                                                      ] =
                                                        $props.discActionsRubric.data[3].id;
                                                      return __composite;
                                                    })()}
                                                    placeholder={"Select..."}
                                                    popupScopeClassName={
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicDrawerOldV2__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicDrawerOldV2__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicDrawerOldV2__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicDrawerOldV2__ArgProps,
          internalVariantPropNames: PlasmicDrawerOldV2__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicDrawerOldV2__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "drawerV2") {
    func.displayName = "PlasmicDrawerOldV2";
  } else {
    func.displayName = `PlasmicDrawerOldV2.${nodeName}`;
  }
  return func;
}

export const PlasmicDrawerOldV2 = Object.assign(
  // Top-level PlasmicDrawerOldV2 renders the root element
  makeNodeComponent("drawerV2"),
  {
    ...
    // Metadata about props expected for PlasmicDrawerOldV2
    internalVariantProps: PlasmicDrawerOldV2__VariantProps,
    internalArgProps: PlasmicDrawerOldV2__ArgProps
  }
);

export default PlasmicDrawerOldV2;
/* prettier-ignore-end */
