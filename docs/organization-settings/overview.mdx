...
| Role Level | Access |
|------------|--------|
| Operator | Full access to all settings |
| Leadership | Access to most settings (except Users in some cases) |
| Others | Typically no access to settings |

<Note>
Levelset administrators always have full access regardless of role.
</Note>
