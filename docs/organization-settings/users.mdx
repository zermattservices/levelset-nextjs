...
- Don't send passwords in plain text email
- Use a secure messaging app
- Tell them verbally if possible
- Have them change it after first login (when available)
...
- **Some leadership roles** may have limited user management
- **Levelset administrators** have full access

The Operator's email can only be changed by themselves or a Levelset admin (to prevent lockouts).
...
<CardGroup cols={2}>
  ...
  <Card title="Regular Reviews" icon="magnifying-glass">
    Periodically check the user list and remove people who no longer need access
  </Card>
  <Card title="Secure Sharing" icon="shield">
    Share credentials securely, not via unencrypted email
  </Card>
  <Card title="Use Google SSO" icon="key">
    Encourage Google sign-in for better security
  </Card>
</CardGroup>
